...
export default function CreateListing() {
  ...
  return (
    <main className="p-6 max-w-4xl mx-auto bg-gray-800 text-white rounded-lg shadow-md">
    ...
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
      <div className="flex flex-col gap-4 flex-1">
        <input
          type="text"
          placeholder="Name"
          className="border p-3 rounded-lg text-white bg-gray-800 focus:outline-none focus:border-blue-500"
          id="name"
          maxLength="62"
          minLength="10"
          required
  ...
  formData.imageUrls.map((url, index) => (
    <div
      key={url}
      className="flex justify-between p-3 border items-center bg-gray-800 rounded-lg mb-4"
    >
      <img
        src={url}
        alt="listing image"
