    ...
    <div className="p-6 max-w-lg mx-auto bg-gray-800 text-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <input
          ...
          className="border p-3 rounded-lg bg-gray-700 text-white focus:outline-none focus:border-blue-500"
          id="username"
      ...
      <button
        ...
        className="bg-gray-700 text-white p-3 rounded-lg uppercase hover:opacity-95"
      >
        Show Listings
      </button>
